...
def welcomeUser():
  display.DrawRect()
  display.PrintText("Welcome!", cords=(4, 7), FontSize=13)
  display.ShowImage()
  sleep(2)
  display.DrawRect()
  display.PrintText("Loading...", cords=(4, 7), FontSize=13)
  display.ShowImage()
  sleep(1)
  waitingToRead()
...
def waitingToRead():
  display.DrawRect()
  display.PrintText("Waiting To Read", cords=(4, 7), FontSize=11)
  display.ShowImage()
        
def displayRead():
  display.DrawRect()
  display.PrintText("ID Read, Starting...", cords=(4, 7), FontSize=11)
  display.ShowImage()

def displayTimer():
  display.DrawRect()
  display.PrintText("Logged In, Counting", cords=(4, 7), FontSize=11)
  display.ShowImage()

def displayEnd():
  display.DrawRect()
  display.PrintText("Done, Goodbye!", cords=(4, 7), FontSize=11)
  display.ShowImage()